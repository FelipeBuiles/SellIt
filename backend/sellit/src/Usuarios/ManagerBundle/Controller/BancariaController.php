...
class OfertasController extends Controller {
    ...
    public function ofertarAction() {
        ...
        $comentarios = (isset($data['comentarios']) && !empty($data['comentarios'])) ? $data['comentarios'] : '';
        ...
        $response->setData(array('result' => true, 'message' => 'Offer  successfully inserted', 'id' => $oferta->getId()));
